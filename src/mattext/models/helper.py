...
def count_tokens_and_plot(
    dataset_path: str,
    representation: str,
    context_length: int,
    report_path: str = "token_count_report.txt",
    plot_path: str = "token_count_plot.png",
):
    ...
    with open(report_path, "a") as report_file:
        ...
        report_file.write(
            f"Number of entries exceeding context length: {num_entries_exceeding_context}\n"
        )

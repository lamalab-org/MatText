...
def main(cfg: DictConfig) -> None:
    ...
    for benchmark_name in benchmarks:
        ...
        for fold in benchmark.folds:
            ...
            train_data = [{"structure": convert_structure_to_serializable(train_inputs[index]), "labels": train_outputs[index]} for index in range(len(train_inputs))]
            ...
            test_data = [convert_structure_to_serializable(test_inputs[index]) for index in range(len(test_inputs))]

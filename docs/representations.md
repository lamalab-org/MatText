...
For example, to obtain the `cif_p1`, `slices`, `atom_sequences_plusplus`, `crystal_text_llm`, and `zmatrix` representations, use the following code:
...
- **Atom Sequences++** (`atom_sequences_plusplus`): List of atoms with lattice parameters.
- **SLICES** (`slices`): SLICES representation of the crystal structure.
...
text_representations_requested = ["atom_sequences", "crystal_text_llm"]
...
??? success "output"
    ...
    {'atom_sequences': 'N N N N', 'crystal_text_llm': '5.6 5.6 5.6\n90 90 90\nN0+\n0.02 0.02 0.02\nN0+\n0.98 0.52 0.48\nN0+\n0.52 0.48 0.98\nN0+\n0.48 0.98 0.52'}
...
text_rep = TextRep.from_input(structure_1, transformations)
text_representations_requested = ["crystal_text_llm"]
...
??? success "output"
    ...
    ```bash
    Translated Text Representations:{'crystal_text_llm': '3.9 3.9 3.9\n90 90 90\nO2-\n0.76 0.98 0.41\nTi4+\n0.77 0.98 0.89\nO2-\n0.76 0.49 0.89\nO2-\n0.26 0.97 0.88\nSr2+\n0.25 0.47 0.38'}
